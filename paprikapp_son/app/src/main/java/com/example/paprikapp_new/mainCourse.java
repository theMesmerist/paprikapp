...
public class mainCourse extends AppCompatActivity {
    ...
    public void listAlcohol() {
        ...
        f = false;
        quantity = 0;
        DatabaseReference zonesRef = FirebaseDatabase.getInstance().getReference("item").child("mainCourse");
        ...
        zonesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot key : keys) {
                    getTotal();
                    Button btn = new Button(mainCourse.this);
                    ImageView iv = new ImageView(mainCourse.this);
                                    ...
                                    handler.postDelayed(new Runnable() {
                                        public void run() {
                                            if (Integer.valueOf(quan.getText().toString()) <= maxQ) {
                                                ...
                                                Toast toast = Toast.makeText(mainCourse.this,"Succesfully added "+Integer.valueOf(quan.getText().toString())+" "+itemName, Toast.LENGTH_LONG);
                                                toast.show();
                                                getTotal();
                                            } else {
                                                Toast toast = Toast.makeText(mainCourse.this, "We don't have that much, you can only have " + maxQ + " of it", Toast.LENGTH_LONG);
                                                toast.show();
