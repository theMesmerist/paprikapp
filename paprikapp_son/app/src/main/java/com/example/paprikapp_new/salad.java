...
public class salad extends AppCompatActivity {
    ...
    public void listAlcohol() {
        ...
        f = false;
        quantity = 0;
        DatabaseReference zonesRef = FirebaseDatabase.getInstance().getReference("item").child("salad");
        ...
        zonesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot key : keys) {
                    getTotal();
                    Button btn = new Button(salad.this);
                    ImageView iv = new ImageView(salad.this);
                                    ...
                                    handler.postDelayed(new Runnable() {
                                        public void run() {
                                            if (Integer.valueOf(quan.getText().toString()) <= maxQ) {
                                                ...
                                                Toast toast = Toast.makeText(salad.this,"Succesfully added "+Integer.valueOf(quan.getText().toString())+" "+itemName, Toast.LENGTH_LONG);
                                                toast.show();
                                                getTotal();
                                            } else {
                                                Toast toast = Toast.makeText(salad.this, "We don't have that much, you can only have " + maxQ + " of it", Toast.LENGTH_LONG);
                                                toast.show();
